...
-- ---------------------------------------------------------------------------
-- research_assets — computational/digital research asset registry
-- ---------------------------------------------------------------------------
...
create index if not exists research_asset_chemicals_chemical_idx on public.research_asset_chemicals (chemical_id);
