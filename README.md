...
| 📸 **Delivery photo** | Snap the delivery order/invoice at the bench. Reads a CAS number, price and pack size on-device, free — shown as a checklist you confirm before anything is filled in. |
...
src/
  lib/
    ...
    deliveryPhoto.ts Delivery-photo upload + on-device OCR field extraction
